...
\item[\texttt{v0.04}] Make hook toggles idempotent. Protect single-letter
  words at paragraph starts and after Czech opening quotation marks.
  Preserve typography protection across font kerning, italic corrections,
  and color changes.
